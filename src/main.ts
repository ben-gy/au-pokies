  ...
  app.innerHTML = `
    ...
    <footer class="site-footer">
      <div class="footer-inner">
        ...
        <span>Gambling help: <strong>1800 858 858</strong> · Built by <a href="https://benrichardson.dev/">benrichardson.dev</a> · <a href="https://sites.benrichardson.dev" target="_blank" rel="noopener">more tools &amp; sites</a></span>
      </div>
    </footer>
    ${aboutModal()}
